class Sobre extends React.Component {
  ...
  constructor() {
    super();
    this.state = {instituicao: "Instituto Federal de Educação, Ciência e Tecnologia de São Paulo", 
  ...
  render() {   
    ...
    return <div>
    <p>O <strong>{this.state.instituicao}</strong> – é uma autarquia federal de ensino.</p>
